    ...
    <div className="bg-white">
      ...
      <div className="relative bg-blue-600">
        <div className="max-w-7xl mx-auto py-24 px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 max-w-3xl mx-auto text-blue-200 text-lg md:text-xl">
            Providing quality healthcare services with modern facilities and experienced professionals.
          </p>
          ...
          <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4">
            <Link
              to="/appointments"
              className="px-8 py-3 text-blue-600 bg-white rounded-md font-medium hover:bg-gray-100"
            >
              Book Appointment
            </Link>
            ...
            <Link
              to="/doctors"
              className="px-8 py-3 text-white bg-blue-500 rounded-md hover:bg-blue-700"
            >
              Our Doctors
            </Link>
          </div>
            ...
            {[
              ...
              return (
                <div key={index} className="flex flex-col items-center">
                  <div className="h-12 w-12 flex items-center justify-center bg-blue-600 text-white rounded-md">
        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            {[
              ...
              <div
                key={department.name}
                className="bg-white shadow rounded-lg hover:shadow-xl transition p-5"
              >
      ...
      {/* CTA Section */}
      <div className="bg-blue-600">
        <div className="max-w-7xl mx-auto py-12 px-4 flex flex-col lg:flex-row justify-between items-center gap-6 text-center lg:text-left">
